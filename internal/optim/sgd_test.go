...
func TestSGD(t *testing.T) {
	...
	testcases := []struct {
		...
		{
			Base:       testutils.Base{Name: "incorrect inputs", Err: ErrExec},
			parameters: &SGDParameters{},
			param:      defaultSizeMatrixFactory(2),
		...
		},
		{
			...
			parameters: &SGDParameters{LearnRate: 2},
			param:      defaultSizeMatrixFactory(2),
			grad:       defaultSizeMatrixFactory(1),
		...
		},
		{
			...
			parameters: &SGDParameters{StopLearnRate: 0.001},
			param:      defaultSizeMatrixFactory(2),
			grad:       defaultSizeMatrixFactory(1),
			expected:   matrixSubtractor(defaultSizeMatrixFactory(2), defaultSizeMatrixFactory(1).MulNum(defaultLearnRate)),
		},
		{
			...
			parameters: &SGDParameters{StopLearnRate: 2},
			param:      defaultSizeMatrixFactory(2),
			grad:       defaultSizeMatrixFactory(1),
			expected:   matrixSubtractor(defaultSizeMatrixFactory(2), defaultSizeMatrixFactory(1).MulNum(defaultLearnRate)),
		},
		{
			...
			parameters: &SGDParameters{EpochsCount: 500},
			param:      defaultSizeMatrixFactory(2),
			grad:       defaultSizeMatrixFactory(1),
			expected:   matrixSubtractor(defaultSizeMatrixFactory(2), defaultSizeMatrixFactory(1).MulNum(defaultLearnRate)),
		},
		{
			...
			parameters: &SGDParameters{DecrementType: ExponentialDecrement},
			param:      defaultSizeMatrixFactory(2),
			grad:       defaultSizeMatrixFactory(1),
			expected:   matrixSubtractor(defaultSizeMatrixFactory(2), defaultSizeMatrixFactory(1).MulNum(defaultLearnRate)),
		},
		{
			...
			parameters: &SGDParameters{
				...
				EpochsCount:   5,
				DecrementType: ExponentialDecrement,
			},
			param:    defaultSizeMatrixFactory(2),
			grad:     defaultSizeMatrixFactory(1),
